# El Shaddai 健全度診断システム v1.7

El Shaddai は、三体戦略における監査対象資産を **Permanent Holdings / Value Opportunity Only** と **Role-Audited Assets** に分け、説明可能性を優先して診断する v1.7 初期版です。売買予測やブラックボックスの機械学習モデルではなく、スポット買い好機、資産の役割健全性、元気玉（追加投資資金）の投入先候補を人間が監査できる形で提示します。

v1.7 は「実運用完成版」ではなく、透明性・説明可能性・監査可能性・将来拡張性を優先した器です。
