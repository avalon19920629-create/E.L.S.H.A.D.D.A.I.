"""Command-line interface for El Shaddai v1.8."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    md_path = write_markdown(scores, output_dir, source_summary, atlas_result=atlas_result, lode_result=lode_result, inferno_result=inferno_result, aura_result=aura_result, arcadia_result=arcadia_result, oracle_result=oracle_result)
