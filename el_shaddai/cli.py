"""Command-line interface for El Shaddai v1.5.1."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    md_path = write_markdown(scores, output_dir, source_summary, lode_result=lode_result, inferno_result=inferno_result, aura_result=aura_result)
    html_path = write_html(scores, output_dir, aura_result=aura_result)
