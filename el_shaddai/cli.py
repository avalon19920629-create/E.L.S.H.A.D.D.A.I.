"""Command-line interface for El Shaddai v1.6."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    scores = score_all(prices, role_inputs, data_date)
    csv_path = write_csv(scores, output_dir)
    md_path = write_markdown(scores, output_dir, source_summary, lode_result=lode_result, inferno_result=inferno_result, aura_result=aura_result, arcadia_result=arcadia_result)
    html_path = write_html(scores, output_dir, aura_result=aura_result, arcadia_result=arcadia_result)
